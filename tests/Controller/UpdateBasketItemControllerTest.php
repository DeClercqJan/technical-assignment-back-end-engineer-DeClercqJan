...
class UpdateBasketItemControllerTest extends WebTestCaseBase
{
    public function testUpdateBasketItemController(): void
    {
        ...
        $this->client->request(
            ...
            sprintf('/api/basket-items/%s', $basketItemUuid),
            [],
            [],
            [
                'CONTENT_TYPE' => 'application/json',
